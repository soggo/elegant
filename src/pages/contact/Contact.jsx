...
const Contact = () => {
  return(
      ...
      <div className="self-start mb-10">
          ...
          <p className="mt-5">Our features timeless furniture, with natural fabrics, curved lines, plenty of mirrors and classic design, which <br /> can be incorporated into any decor project. The pieces enchant for their sobriety, to last for generations, <br />faithful to the shapes of each period, with a touch of the present</p>
          </div>

          <section className="flex flex-col md:flex-row items-center gap-15  bg-gray-200">
              <img src="close2.png" alt="" className="md:w-140"/>
              <div className="flex flex-col gap-5 md:p-2 px-4 py-8">
          ...
          <p className="text-3xl text-center my-10">Contact Us</p>

          <div className="flex flex-col md:flex-row gap-4">

              <div className="bg-gray-300 md:w-90 h-35 flex flex-col items-center pt-2 px-4">
                  <img src="store.png" alt="" />
                  <p>Address</p>
                  <p className="text-center">234 Hai Trieu, Ho Chi Minh City, <br />
                  Viet Nam</p>
              </div>
...
<form className="mt-10 flex flex-col self-start gap-3">
<div>
  ...
  <input
    ...
    className=" w-80 md:w-2xl px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-black focus:border-black text-sm"
  />
</div>
